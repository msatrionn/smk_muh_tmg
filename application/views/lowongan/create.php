    ...
    <section class="content">
      <div class="container-fluid">
			<div class="card">
				...
				<form action="<?php echo base_url('perusahaan/save') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="alamat">Nomor Telp</label>
						<input type="text" class="form-control" required name="no_telp">
					</div>
					<div class="form-group">
						<label for="">foto perusahaan</label>
						<input type="file" required name="foto_perusahaan" class="form-control"></a>
					</div>
					<div class="form-group">
